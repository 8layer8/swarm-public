...
# If traefik just doesn't work, compare these! Make sure your IP didn't change (it happens rarely, but it actually does change, ask me how I know...)
curl http://icanhazip.com
host traefik.remote.mydomain.com
echo "Make sure the last two things match!"
